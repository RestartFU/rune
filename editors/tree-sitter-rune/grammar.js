  ...
  rules: {
    ...
    type_declaration: $ => seq(
      ...
      choice(
        ...
        seq(
          '(',
          optionalTrailingSep(choice($.type_spec, $.enum_spec, $.type_alias), terminator),
          ')',
        ),
      ),
    ),
    ...
    enum_variant_list: $ => seq(
      '{',
      optionalTrailingSep($.enum_variant, ','),
      '}',
    ),

    enum_variant: $ => seq(
      field('name', $._field_identifier),
      field('body', optional($.enum_variant_field_list)),
    ),

    enum_variant_field_list: $ => seq(
      '{',
      optional(seq(
        $.enum_field,
    ...
    expression_switch_statement: $ => seq(
      choice(
        seq(
          'switch',
          field('initializer', $.rune_switch_binding),
          '{',
    ...
    rune_switch_binding: $ => prec(1, seq(
